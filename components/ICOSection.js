  ...
  const handleFixedBuy = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(
          "Purchase successful! Tokens added to your account",
        );
        updateUserData({
  ...
  const handleCustomBuy = async () => {
    ...
    try {
      ...
      if (res.ok) {
        const result = await res.json();
        alert(
          `Purchase successful! ${result.tokens} tokens added to your account`,
        );
        updateUserData({
