  ...
  useEffect(() => {
    ...
    if (isMining) {
      ...
      timer = setInterval(() => {
        ...
        // Calculate tokens mined based on elapsed time
        const tokensPerMinute = miningRate / 60; // Tokens per millisecond
    ...
    <section style={styles.section}>
      ...
      <div style={styles.miningInfo}>
        <div style={styles.infoCard}>
          ...
          <p style={styles.infoLabel}>{userData.isBuyer ? 'Premium (Buyer)' : 'Silver'}</p>
        </div>
        
        <div style={styles.infoCard}>
          <h4 style={styles.infoTitle}>Total Mined</h4>
          <p style={styles.infoValue}>{userData.tokens.toLocaleString()}</p>
      ...
      <div style={styles.miningControls}>
        ...
        <div style={styles.miningStats}>
          <div style={styles.statItem}>
            <span style={styles.statLabel}>Current Session:</span>
            <span style={styles.statValue}>{formatTime(time)}</span>
          </div>
          <div style={styles.statItem}>
            <span style={styles.statLabel}>Session Tokens:</span>
